...
class ExerciseFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_exercise3, container, false)
        createNotificationChannel()
        view.findViewById<Button>(R.id.ex3_start).setOnClickListener {

            startCountdownTimer()
        }
        view.findViewById<Button>(R.id.ex3_stop).setOnClickListener {
            stopCountdownTimer()
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val txt = view.findViewById<TextView>(R.id.exercise3)
        val btnStart = view.findViewById<Button>(R.id.ex3_start)
        val btnStop = view.findViewById<Button>(R.id.ex3_stop)

        txt.text = "Third Exercise"
    }
    ...
    class StopReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            val myFragment = context as ExerciseFragment3
